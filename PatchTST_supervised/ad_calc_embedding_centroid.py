...
if __name__ == '__main__':
    ...
    if not already_saved:
        ...
        sequences = get_all_sequences(csv_data, model_config['seq_len'])
    ...
    if not check_saved('kmeans.pkl', run_path) and not check_saved('kmeans_high_dim.pkl', run_path):
        ...
        joblib.dump(kmeans, f'{run_path}/kmeans.pkl')
        joblib.dump(kmeans_high_dim, f'{run_path}/kmeans_high_dim.pkl')
    ...
    if not check_saved('centroid.npy', run_path) and not check_saved('centroid_high_dim.npy', run_path):
        ...
        centroid_high_dim = kmeans_high_dim.cluster_centers_
